...
ActiveRecord::Schema[7.0].define(version: 2024_11_12_043310) do
  ...
  create_table "report_mentions", force: :cascade do |t|
    ...
    t.index ["mentioning_report_id", "mentioned_report_id"], name: "index_report_mentions_on_report_ids", unique: true
