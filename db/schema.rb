...
ActiveRecord::Schema[7.0].define(version: 2024_11_11_014528) do
  ...
  add_foreign_key "report_mentions", "mentioned_reports"
  add_foreign_key "report_mentions", "mentioning_reports"
